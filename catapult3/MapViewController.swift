...
//        startlat = 37.37
//        startlong = -121.90
        let camera = GMSCameraPosition.camera(withLatitude:  startlat, longitude: startlong, zoom: 13.0)
        
        let mapView = GMSMapView.map(withFrame: CGRect(x: 50, y: 50, width: 300, height: 300), camera: camera)
